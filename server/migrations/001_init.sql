...
PRAGMA
secure_delete = ON;       -- zero-fill deleted pages (TTL data)
...
(
    ...
    uploaded_at INTEGER NOT NULL DEFAULT
(
    unixepoch
(
))
...
(
    ...
    user_b_id TEXT NOT NULL REFERENCES users
(
    id
)
  ON DELETE CASCADE,
...
(
    ...
    blocked_id TEXT NOT NULL REFERENCES users
(
    id
)
  ON DELETE CASCADE,
...
(
    ...
    stored_at INTEGER NOT NULL DEFAULT
(
    unixepoch
(
)),
...
(
    ...
    TEXT
    PRIMARY
    KEY, -- server-assigned random ID (secrets.token_hex(16))
    user_a_id
    TEXT
    NOT
    NULL
...
(
    ...
    TEXT
    PRIMARY
    KEY, -- e.g. "login:192.168.1.1" or "register:username"
    attempts
    INTEGER
    NOT
    NULL
